...
const ShippingPage = () => {
  ...
  const { value: remember, handleToggleValue: handleRemember } = useToggleValue()
  return (
    <div className="flex items-start w-full gap-x-[74px]">
      <div className="flex-1">
        ...
        <div className="flex items-center gap-x-5 mb-11">
          <Checkbox checked={remember} onClick={handleRemember}>Remember this address for next time use</Checkbox>
        </div>
